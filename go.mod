...
require (
	buf.build/gen/go/parca-dev/parca/connectrpc/go v1.18.1-20250212095114-4db6f2d46517.1 // @grafana/observability-traces-and-profiling
	buf.build/gen/go/parca-dev/parca/protocolbuffers/go v1.36.2-20250212095114-4db6f2d46517.1 // @grafana/observability-traces-and-profiling
	...
	github.com/openfga/api/proto v0.0.0-20250107154247-c22e6db5c4f5 // @grafana/identity-access-team
	github.com/openfga/language/pkg/go v0.2.0-beta.2.0.20241115164311-10e575c8e47c // @grafana/identity-access-team
	github.com/openfga/openfga v1.8.4 // @grafana/identity-access-team
